...
export default function Footer() {
  return (
    <div className='flex justify-center w-full p-12 gap-16 lg:flex-row flex-col'>
      <div className='text-center lg:md:text-left'>
        <h1 className='text-4xl text-[#009045] font-bold mb-4'>CONCIPE 2023</h1>
        <p className='lg:w-[35ch] text-black text-2xl'>

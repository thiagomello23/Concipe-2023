  ...
  return (
    <div className='p-12 bg-gray-light'>
      ...
      <div className='flex items-center justify-center flex-wrap gap-10 mt-8'>
        ...
        <Evento bgImage={BGImage} title='Minicurso' data='27/09' body='- 19h - Minicursos – simultâneo nas duas unidades Unifasipe' />
        <Evento bgImage={BGImage} title='Minicurso' data='28/09' body='- 19h - Minicursos – simultâneo nas duas unidades Unifasipe' />
